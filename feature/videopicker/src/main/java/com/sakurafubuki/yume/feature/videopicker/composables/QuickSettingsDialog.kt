...
fun QuickSettingsDialog(
    ...
    NextDialog(
        ...
        title = {
            Text(text = stringResource(R.string.video_quick_settings))
        },
        content = {
            HorizontalDivider()
            Column(
                ...
                DialogSectionTitle(text = stringResource(R.string.video_view_mode))
                ...
                DialogSectionTitle(text = stringResource(R.string.video_layout))
                SingleChoiceSegmentedButtonRow(
                    modifier = Modifier.fillMaxWidth(),
                ) {
