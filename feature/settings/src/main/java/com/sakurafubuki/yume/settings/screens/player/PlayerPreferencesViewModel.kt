...
class PlayerPreferencesViewModel @Inject constructor(
    ...
    private fun toggleDeband() {
        viewModelScope.launch {
            preferencesRepository.updatePlayerPreferences {
                it.copy(enableDeband = !it.enableDeband)
            }
        }
    }

    private fun updateAnime4KRestoreMode(mode: Anime4KRestoreMode) {
        viewModelScope.launch {
            preferencesRepository.updatePlayerPreferences {
                it.copy(anime4KRestoreMode = mode)
            }
        }
    }
    ...
    private fun toggleAnime4KClampHighlights() {
        viewModelScope.launch {
            preferencesRepository.updatePlayerPreferences {
                it.copy(enableAnime4KClampHighlights = !it.enableAnime4KClampHighlights)
            }
        }
    }
