...
import com.sakurafubuki.yume.core.datastore.datasource.AppPreferencesDataSource
import com.sakurafubuki.yume.core.datastore.datasource.PlayerPreferencesDataSource
...
class LocalPreferencesRepository @Inject constructor(
    ...
    override val applicationPreferences: StateFlow<ApplicationPreferences> =
        appPreferencesDataSource.preferences.distinctUntilChanged().stateIn(
