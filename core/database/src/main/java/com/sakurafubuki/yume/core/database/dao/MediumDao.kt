...
interface MediumDao {
    ...
    @Transaction
    @Query("SELECT * FROM media WHERE parent_path = :directoryPath LIMIT :limit OFFSET :offset")
    fun getAllWithInfoFromDirectoryPaginated(directoryPath: String, limit: Int, offset: Int): Flow<List<MediumWithInfo>>
